...
def save_uploaded_bill(file_content: bytes, bills_dir: Path) -> Dict[str, Union[str, None]]:
    """
    ...
    if not uploaded_file.name.lower().endswith('.pdf'):
        ...
        try:
            ...
            if response_data.get('summary'):
                ...
                st.warning("⚠️ AI summarization failed or is pending. Bill uploaded successfully but without analysis.")
